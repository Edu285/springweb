...
@ComponentScan(basePackages= {"service","dao","utilidades"})	//anotacion para incluir los paquetes
@PropertySource("classpath:config/application.properties")  // para que encuentre el archivo de properties
@EnableTransactionManagement // para habilitar el uso de Transacciones por anotaciones
